...
#New_York_uninsured_mutate = New_York_uninsured %>% mutate (Uninsured = as.numeric(gsub(",","", New_York_uninsured[,3])))

#head(New_York_uninsured_mutate)
...
plot(x1, y1, main = "Uninsured vs. less than high school education")
...
y2 <- High_School
lm2 <- lm(y2 ~ x2)
plot(x2, y2, main = "Uninsured vs. high school diploma")
...
y3 <- College_Grad
lm3 <- lm(y3 ~ x3)
plot(x3, y3, main = "Uninsured vs. College Graduate")
